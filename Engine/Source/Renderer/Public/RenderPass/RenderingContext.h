...
struct FRenderingContext
{
    ...
    FRenderingContext(class UCamera* InCurrentCamera, EViewModeIndex InViewMode, uint64 InShowFlags, const D3D11_VIEWPORT& InViewport, const FVector2& InRTSize, ID3D11Buffer* InModelCB)
